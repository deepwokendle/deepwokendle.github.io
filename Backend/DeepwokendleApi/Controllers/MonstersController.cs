    ...
    public class MonstersController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<MonsterDto>> Get()
        {
            var monsters = new List<Monster>
            {
                ...
                new Monster { Id =  3, Name = "Owl",                 Picture = "/img/owl.png",                 Humanoid = false, ElementId = 1, CategoryId = 2 },
                ...
                new Monster { Id =  9, Name = "Mudskipper",          Picture = "/img/mudskipper.jpg",          Humanoid = false, ElementId = 2, CategoryId = 2 },
