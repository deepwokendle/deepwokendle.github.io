...
public class MonstersController : ControllerBase
{
    ...
    public ActionResult<IEnumerable<MonsterDto>> Get()
    {
        var monsters = new List<Monster>
        {
            ...
            new Monster { Id = 16, Name = "Enforcer", Picture = "/img/Swordforcer.webp", FightingStyle = "Heavy Weapons", MainHabitat = "The Depths", Humanoid = false, CategoryId = 2 },
            new Monster { Id = 17, Name = "Scion of Ethiron", Picture = "/img/Ethiron.jpg", FightingStyle = "Galebreathe", MainHabitat = "Layer 2", Humanoid = false, CategoryId = 4 },
